...
class TestAscCodePair:
    ...
    def test_code_pair_device_units_respected(self, client):
        ...
        assert proc_line_1.code_pair_offset > 0, "First procedure should have code pair offset"
        assert proc_line_1.code_pair_device == "C1601"

        assert proc_line_2.code_pair_offset > 0, "Second procedure should also have code pair offset"
    ...
    def test_code_pair_single_unit_limits_offset(self, client):
        ...
        assert proc_line_2.code_pair_offset == 0, "Second procedure should NOT have offset (only 1 device unit)"
